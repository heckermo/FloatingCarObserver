...
_C.OUTPUT_DIR = ""#"carla_train"                 # Output Directory
...
# Data
_C.DATA = CN()
_C.DATA.ROOT = None # KITTI Root
_C.DATA.BATCH_SIZE = 11
_C.DATA.NUM_WORKERS = 11
_C.DATA.TRAIN_SPLIT = 'training'
_C.DATA.TEST_SPLIT = 'testing'
