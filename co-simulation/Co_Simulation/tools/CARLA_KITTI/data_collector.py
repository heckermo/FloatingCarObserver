...
from start_carla import start_carla
from utils.world_utils import generate_traffic_carla
...
def main():
    start_carla()
    generate_traffic_carla(os.path.join(os.path.expanduser('~'),'CARLA_Shipping_0.9.14_KIVI','LinuxNoEditor'), 10, 0)    

    args = get_config('data_collector.yaml')
