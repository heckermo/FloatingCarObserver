...
class TfcoDatasetGenerator():
    def __init__(self, filename: str, center_of_interest: Tuple[float, float], radius: int, add_info: str, detector: Detector):
        self.filename = os.path.join('tfco_datasets', filename, str(add_info+'_dataset.pkl'))
